...
@WebServlet("/responseredirectmore")
public class ResponseRedirectMore extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		// flush , close gibi metotlari cagirdigimizda response commit edilir
		// bundan sonra

		// sendRedirect cagrilirsa java.lang.IllegalStateException hatasi
		// verecektir.

		resp.sendRedirect("/HelloServletWorld/Html/redirectMe.html");
